...
class Widgets extends REST_Controller {
    ...
    public function getBotIA_post() {
        ...
        $dataBot['cintura'] = $dataRequest['item']['queryResult']['outputContexts'][0]['parameters']['cint'];
        ...
        log_message("DEBUG", "Cintura: ".$dataRequest['item']['queryResult']['outputContexts'][0]['parameters']['cint']);
        ...
        if ($dataStat !== FALSE){
            ...
            // Set the response and exit
            $this->response([
                'fulfillmentText' => "Muchas gracias por usar nuestros servicios"
            ], REST_Controller::HTTP_OK); // NOT_FOUND (404) being the HTTP response code

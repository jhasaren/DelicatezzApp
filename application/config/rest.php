...
|
*/
//$config['rest_auth'] = 'digest'; /*jasanchez*/
...
*/
$config['auth_source'] = '';
//$config['auth_source'] = 'library'; /*jasanchez*/
...
|
*/
//$config['auth_library_class'] = 'api_auth'; /*jasanchez*/
//$config['auth_library_function'] = 'login'; /*jasanchez*/
$config['auth_library_class'] = ''; /*jasanchez*/
$config['auth_library_function'] = ''; /*jasanchez*/
...
|
*/
$config['rest_ip_whitelist_enabled'] = FALSE; /*JASANCHEZ*/
...
|
*/
$config['rest_ip_whitelist'] = ''; /*JASANCHEZ*/
...
|
*/
$config['rest_ajax_only'] = FALSE; /*JASANCHEZ*/
...
|
*/
$config['check_cors'] = TRUE; /*JASANCHEZ*/
...
|
*/
$config['allow_any_cors_domain'] = TRUE; /*JASANCHEZ*/
...
//$config['allowed_cors_origins'] = ['http://localhost','https://tiendacarrusel.com']; /*JASANCHEZ*/

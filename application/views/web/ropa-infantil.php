            ...
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center">
                    <div class="col-md-9 ftco-animate text-center">
                        <img src="<? echo base_url() . 'public/web/images/icon-mode.png'; ?>" /><br />
                        <span style="color: gray; font-size: 35px; font-family: 'Oleo Script', cursive;">Ropa Infantil</span>
                        <!--<h1 class="mb-0 bread">Contacto</h1>-->
                        <p class="breadcrumbs"><span class="mr-2">Colección Bebes, Niñas, Niños</span></p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-sm col-md-6 col-lg-3 ftco-animate">
                                <div class="product">
                                    <a href="#" data-toggle="modal" data-target="#detailModal" data-id="<?php echo $obj['idProducto']; ?>" class="img-prod detailModel" >
                                        <center><img class="img-fluid" src="<? echo $obj['urlImagen']; ?>" alt="<?php echo $obj['etiqueta']; ?>" ><!--style="height: 500px; width: auto;"--></center>

            ...
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center">
                    <div class="col-md-9 ftco-animate text-center">
                        <img src="<? echo base_url() . 'public/web/images/icon-pets.png'; ?>" /><br />
                        <span style="color: gray; font-size: 35px; font-family: 'Oleo Script', cursive;">Mascotas</span>
                        <!--<h1 class="mb-0 bread">Contacto</h1>-->
                        <p class="breadcrumbs"><span class="mr-2">Prendas y Accesorios</span></p>
                    </div>
                </div>
            </div>
        </div>

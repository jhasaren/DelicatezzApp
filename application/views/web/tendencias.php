...
<html lang="es">
    ...
    <body>
            ...
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center">
                    <div class="col-md-9 ftco-animate text-center">
                        <img src="<? echo base_url() . 'public/web/images/icon-star.png'; ?>" /><br />
                        <span style="color: gray; font-size: 35px; font-family: 'Oleo Script', cursive;">Tendencias</span>
                        <!--<h1 class="mb-0 bread">Contacto</h1>-->
                        <p class="breadcrumbs"><span class="mr-2">Últimas Colecciones</span></p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-sm col-md-6 col-lg-3 ftco-animate">
                                <div class="product">
                                    ...
                                    if ($obj['idCategoria'] == 1) { 
                                        $catModal = 'detailModalPrenda'; 
                                    } else {
                                        $catModal = 'detailModal'; 
                                    }
                                    ?>
                                    <a href="#" data-toggle="modal" data-target="#<?php echo $catModal; ?>" data-id="<?php echo $obj['idProducto']; ?>" class="img-prod <?php echo $catModal; ?> detailModel" >
                                    ...
                                    <div class="text pt-3 px-3"align="center">
                                        <h3 style="font-size: 35px; font-family: 'Oleo Script', cursive;">
                                            <a href="<?php echo base_url().'CPrincipal/line/2'; ?>" style="color: gray">
                                                <img style="width: 64px; height: 64px" src="<? echo base_url() . 'public/web/images/icon-corbata.png'; ?>" />
                                                Accesorios
                                            </a>
                                        </h3>
                                    </div>
        ...
        <!-- Modal Prendas -->
        <div class="modal fade" id="detailModalPrenda" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title nameModalLabel"></h5>
                    ...
                    <div class="modal-body">
                        <center>
                            ...
                            <!--Valor de Prenda-->
                            <span style="font-size: 20px; color: #000">Calcula el valor de la prenda</span><br />
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <div class="select-wrap">
                                            <div class="icon"><span class="ion-ios-arrow-down"> </span>Elige el rango de Edad</div>
                                            <select name="" id="" class="form-control rangesYear" >
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <div class="select-wrap">
                                            <center>
                                            <div class="icon"><span class="ion-ios-arrow-down"> </span>Elige la Talla</div>
                                            <select name="" id="" class="form-control listTales">
                                            </select>
                                            </center>
                                        </div>
                                    </div>
                            ...
                            <span style="font-size: 15px; color: #ff00cc">
                                <a href="<?php echo base_url().'public/web/images/guia-tallas-carrusel-082020.jpg'; ?>" class="btn btn-info" target="_blank" style="color: #fff">Ver Guía de Tallas</a>
                            </span>
                            <br /><br />
                            <div class="valorPrenda" style="font-size: 45px; color: #000"></div>
